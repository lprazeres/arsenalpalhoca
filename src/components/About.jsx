        ...
        <Container className={styles.about}>
            <div className={styles.borderA}>
                <div className={styles.borderB}>
                    ...
                    <p>
                        Fomos fundada em 2006, somos a maior torcida organizado do Arsenal da Palhoça. Nossa missão é apoiar o Arsenal nas vitórias (que sejam muitas), ou nas derrotas.
                    </p>
                    <p>
