        ...
        <Container className={styles.about}>
            <div className={styles.borderA}>
                <div className={styles.borderB}>
                    ...
                    <p>
                        Somos fundados em 2009, somos a maior torcida organizado do Arsenal da Palhoça. Nossa missão é apoiar o Arsenal nas vitórias (que sejam muitas), ou nas derrotas.
                    </p>
                    <p>
